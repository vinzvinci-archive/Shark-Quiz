...
public class GFemaleLevel4 extends javax.swing.JFrame {

 /*
 * Developer: Vincent Villafuerte
 */
    
    public GFemaleLevel4() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblDivide.setFont(new java.awt.Font("Tahoma", 0, 30)); // NOI18N
        lblDivide.setForeground(new java.awt.Color(255, 255, 255));
        lblDivide.setText("/");
        jPanel2.add(lblDivide, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 30, -1, 30));
        ...
        lblNum2.setText("?");
        jPanel2.add(lblNum2, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 30, -1, 30));

        lblNum1.setFont(new java.awt.Font("Tahoma", 0, 30)); // NOI18N
        lblNum1.setForeground(new java.awt.Color(255, 255, 255));
        lblNum1.setText("?");
        jPanel2.add(lblNum1, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 30, -1, 30));
        ...
        lblHP8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vvproject/Life.png"))); // NOI18N
        jPanel9.add(lblHP8, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 0, -1, 30));

        lblHP9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vvproject/Life.png"))); // NOI18N
        jPanel9.add(lblHP9, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 0, -1, 30));

        lblHP10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vvproject/Life.png"))); // NOI18N
        jPanel9.add(lblHP10, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 0, -1, 30));

        jPanel3.add(jPanel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, 300, 30));
        ...
        lblNxtLevel.setForeground(new java.awt.Color(255, 0, 0));
        lblNxtLevel.setText("Exit");
        PnlLvlHide.add(lblNxtLevel, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 10, 30, 20));

        PnlLevel1.add(PnlLvlHide, new org.netbeans.lib.awtextra.AbsoluteConstraints(1190, 330, 100, -1));
        ...
        lblHeroDie.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vvproject/FHeroDie.gif"))); // NOI18N
        PnlLevel1.add(lblHeroDie, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, -1, -1));

        lblHeroSave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vvproject/FHeroSave.gif"))); // NOI18N
        PnlLevel1.add(lblHeroSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, -1, -1));

        lblMain.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vvproject/FHeroesBGD.gif"))); // NOI18N
    ...
    private void txtAnswerKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtAnswerKeyPressed
        if (evt.getKeyCode()==KeyEvent.VK_ENTER){
            ...
            if (wrong==9) {
                lblHP10.setEnabled(false);
            }
            if (wrong==8) {
                lblHP9.setEnabled(false);
            }
            if (wrong==7) {
                lblHP8.setEnabled(false);
            }
            if (wrong==6) {
            ...
            int num_1 = (int) (Math.random() *300);
            lblNum1.setText("" + num_1);
            int num_2 = (int) (Math.random() *300);
    ...
    public static void getLevel_Exit() {
        lblNextLevel.setText("" + Levels.Level_Exit);
    ...
    int v=4;
        ...
        v--;
         ...
         if (v==0) {
             GameOverStateF cont = new GameOverStateF();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GFemaleLevel4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GFemaleLevel4 myFrame = new GFemaleLevel4();
                myFrame.setVisible(true);
                myFrame.setExtendedState(myFrame.getExtendedState() | JFrame.MAXIMIZED_BOTH);
            }
        });
