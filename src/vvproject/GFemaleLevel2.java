...
public class GFemaleLevel2 extends javax.swing.JFrame {

 /*
 * Developer: Vincent Villafuerte
 */
    
    public GFemaleLevel2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblMinus.setFont(new java.awt.Font("Tahoma", 0, 30)); // NOI18N
        lblMinus.setForeground(new java.awt.Color(255, 255, 255));
        lblMinus.setText("-");
        jPanel2.add(lblMinus, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 30, -1, 30));
        ...
        lblNum2.setText("?");
        jPanel2.add(lblNum2, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 30, -1, 30));
        ...
        jPanel3.add(jPanel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 10, 150, 30));
        ...
        lblSCT1.setText("7");
        jPanel11.add(lblSCT1, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 0, -1, 30));
        ...
        lblNxtLevel.setText("Level_3");
        PnlLvlHide.add(lblNxtLevel, new org.netbeans.lib.awtextra.AbsoluteConstraints(26, 10, 60, 20));
    ...
    private void txtAnswerKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtAnswerKeyPressed
        if (evt.getKeyCode()==KeyEvent.VK_ENTER){
            ...
            int num_1 = (int) (Math.random() *80);
            lblNum1.setText("" + num_1);
            int num_2 = (int) (Math.random() *40);
    ...
    public static void getLevel_3() {
        lblNextLevel.setText("" + Levels.Level_3);
        GFemaleLevel3 myFrame = new GFemaleLevel3();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GMaleLevel2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GMaleLevel2 myFrame = new GMaleLevel2();
                myFrame.setVisible(true);
                myFrame.setExtendedState(myFrame.getExtendedState() | JFrame.MAXIMIZED_BOTH);
            }
        });
    ...
    private javax.swing.JLabel lblHeroDie;
