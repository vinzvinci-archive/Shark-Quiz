...
public class GameModeFemale extends javax.swing.JFrame {

 /*
 * Developer: Vincent Villafuerte
 */    
    
    public GameModeFemale() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblPlus.setText("+");
        jPanel2.add(lblPlus, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 30, -1, 30));
        ...
        jPanel3.add(jPanel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 10, 90, 30));
    ...
    private void txtAnswerKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtAnswerKeyPressed
        ...
        if (evt.getKeyCode()==KeyEvent.VK_ENTER){
            ...
            int num_1 = (int) (Math.random() *20);
            lblNum1.setText("" + num_1);
            int num_2 = (int) (Math.random() *20);
    ...
    public static void getLevel_2() {
        lblNextLevel.setText("" + Levels.Level_2);
        GFemaleLevel2 myFrame = new GFemaleLevel2();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GameModeMale.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GameModeMale myFrame = new GameModeMale();
                myFrame.setVisible(true);
                myFrame.setExtendedState(myFrame.getExtendedState() | JFrame.MAXIMIZED_BOTH);
            }
        });
