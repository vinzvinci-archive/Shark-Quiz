...
public class GameRewardLuke extends javax.swing.JFrame {
    
    public GameRewardLuke() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnHome, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 300, 280, -1));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 100, 720, 380));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vvproject/Lukee.gif"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GameRewardLuke.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
